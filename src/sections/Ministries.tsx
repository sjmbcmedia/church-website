...
const Ministries = () => {
  ...
  const ministries = [
    ...
    },
    {
      ...
      description: 'Serving our local community through outreach, support, and the Mercy Outreach Center.',
    ...
    },
    {
      ...
      description: 'Extending our mission beyond borders to share the Gospel and support communities worldwide.',
      image: '/ministry-5-sj.jpg',
      icon: Globe,
